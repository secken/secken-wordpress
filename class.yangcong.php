...
EOF;
			...
			print '<p id="yangcong_login_bt"><a href="javascript:;" onclick="jQuery(this).parent().hide();jQuery(\'#yangcong_login\').fadeToggle();"><img src="./wp-content/plugins/yangcong/image/login.jpg"  alt="洋葱扫一扫登录" /></a></p>';
		}else{
			echo 22;
		}
	}
